...
package com.gitblit.console.util;
...
public class MediaTypes {
    ...
    public static final MediaTypes DEFAULT;
    ...
    MediaTypes(final Map<String, String> mappings) {
        this.mappings = mappings;
    }

    public static String getMediaType(final String extension) {
        return DEFAULT.mappings.get(Files.getFileExtension(extension).toLowerCase(Locale.ENGLISH));
    }
    ...
    public static class Builder {
        ...
        public MediaTypes build() {
            return new MediaTypes(mappings);
        }
    }
